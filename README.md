...
- Replace `assets/Marion_Vanier_Resume_2026.pdf` to update the downloadable resume.
...
- Project cards and case-study panels are generated from `site-data.js`, so future projects should be added there.

## GitHub Pages

In the GitHub repo, enable Pages from the `main` branch and root folder.
